...
const S3FileUpload: FC<FieldProps<string>> = (props) => {
  const { onChange, formData, disabled, readonly, required, multiple, value, options, registry, formContext } = props;
...
export default S3FileUpload;
  ...
  export interface  IFilePreviewProps {file: File}
  ...
  export const FilePreview = function({file}:IFilePreviewProps){
    ...
    if (type.indexOf('image') !== -1) {
      ...
      return ( <video width={320} height={320} controls autoPlay={true} muted={true}>
